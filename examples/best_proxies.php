...
$data = file('https://api.best-proxies.ru/proxylist.txt?key=1a4cbf910eca75015a92be62fdb8319b&limit=200&level=1,2&&response=1000&type=socks5,https');
...
$resources = [];
for ($i = 0; $i < 200; $i++) {
    $resources[] = \Arachne\HttpResource::fromUrl('https://httpbin.org/ip');
}
