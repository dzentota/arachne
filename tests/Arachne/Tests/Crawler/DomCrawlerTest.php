...
use Arachne\Crawler\DomCrawler as Crawler;
use Arachne\Crawler\NullCrawler;

class DomCrawlerTest extends \PHPUnit_Framework_TestCase
{
...
EOF
    ...
    public function testEq()
    {
        ...
        $this->assertInstanceOf(Crawler::class, $crawler, '->eq() returns a new instance of a crawler');
    ...
    {
        $crawler = $this->createTestCrawler()->filterXPath('//li')->getCrawler();
    ...
    public function testAttr()
    {
        ...
        $this->assertNull($this->createTestCrawler()->filterXPath('//ol')->attr('class'));
    }
    ...
    public function testNodeName()
    {
        ...
        $this->assertNull($this->createTestCrawler()->filterXPath('//ol')->nodeName());
    }
    ...
    public function testText()
    {
        ...
        $this->assertNull($this->createTestCrawler()->filterXPath('//ol')->text());
    }
    ...
    public function testHtml()
    {
        ...
        $this->assertNull($this->createTestCrawler()->filterXPath('//ol')->html());
    }
    ...
    public function testFilterXPath()
    {
        ...
        $this->assertInstanceOf(Crawler::class, $crawler, '->filterXPath() returns a new instance of a crawler');
    ...
    public function testFilter()
    {
        ...
        $this->assertInstanceOf(Crawler::class, $crawler, '->filter() returns a new instance of a crawler');
    ...
    public function testSelectLink()
    {
        ...
        $this->assertInstanceOf(Crawler::class, $crawler, '->selectLink() returns a new instance of a crawler');
    ...
    public function testSelectButton()
    {
        ...
        $this->assertInstanceOf(Crawler::class, $crawler, '->selectButton() returns a new instance of a crawler');
...
HTML;
    ...
    public function testLink()
    {
        ...
        $this->assertInstanceOf(NullCrawler::class, $this->createTestCrawler()->filterXPath('//ol')->link());
    }
...
HTML;
    ...
    public function testForm()
    {
        ...
        $this->assertInstanceOf(NullCrawler::class, $this->createTestCrawler()->filterXPath('//ol')->form());
    }
    ...
    public function testLast()
    {
        ...
        $this->assertInstanceOf(Crawler::class, $crawler, '->last() returns a new instance of a crawler');
    ...
    public function testFirst()
    {
        ...
        $this->assertInstanceOf(Crawler::class, $crawler, '->first() returns a new instance of a crawler');
    ...
    public function testSiblings()
    {
        ...
        $this->assertInstanceOf(Crawler::class, $crawler, '->siblings() returns a new instance of a crawler');
        ...
        $this->assertInstanceOf(NullCrawler::class, $this->createTestCrawler()->filterXPath('//ol')->siblings());
    }
    ...
    public function testNextAll()
    {
        ...
        $this->assertInstanceOf(Crawler::class, $crawler, '->nextAll() returns a new instance of a crawler');

        $nodes = $crawler->nextAll();
        $this->assertEquals(1, $nodes->count());
        $this->assertEquals('Three', $nodes->eq(0)->text());

        $this->assertInstanceOf(NullCrawler::class, $this->createTestCrawler()->filterXPath('//ol')->nextAll());
    }
    ...
    public function testPreviousAll()
    {
        ...
        $this->assertInstanceOf(Crawler::class, $crawler, '->previousAll() returns a new instance of a crawler');

        $nodes = $crawler->previousAll();
        $this->assertEquals(2, $nodes->count());
        $this->assertEquals('Two', $nodes->eq(0)->text());

        $this->assertInstanceOf(NullCrawler::class, $this->createTestCrawler()->filterXPath('//ol')->previousAll());
    }
    ...
    public function testChildren()
    {
        ...
        $this->assertInstanceOf(Crawler::class, $crawler, '->children() returns a new instance of a crawler');
        ...
        $this->assertInstanceOf(NullCrawler::class, $this->createTestCrawler()->filterXPath('//ol')->children());
    ...
    public function testParents()
    {
        ...
        $this->assertInstanceOf(Crawler::class, $crawler, '->parents() returns a new instance of a crawler');
        ...
        $this->assertInstanceOf(NullCrawler::class, $this->createTestCrawler()->filterXPath('//ol')->parents());
    }
